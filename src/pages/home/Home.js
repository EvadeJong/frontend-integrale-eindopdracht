                    ...
                    <div className="pageInnerContainer">
                        {isAuth ?
                            ...
                            <article className='Welcome'>
                                <h1>Welcome</h1>
                                <h3>
                                    Giggles is an app that fetches funny (and really terrible) jokes to put a smile on
                                    the reader's face.
                                    Jokes may also be added to the database, with the aim of making other users laugh.
                                    Giggles main goal is to make people happy, make them smile and forget about any
                                    worries for a while.
                                </h3>
                            </article>
                        }
